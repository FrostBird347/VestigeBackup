...
While there is a custom script contained within this repo to download and update vestiges, it is not being run automatically and thus won't ever be fully up to date.